...
SOURCE_CONF=siteconfig.json.template package.json rollup.config.js rollup.config.codemirror.js config.js.template lexonomy.sqlite.schema crossref.sqlite.schema
