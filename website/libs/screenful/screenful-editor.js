      ...
      if (links.out.length > 0) {
        ...
        for (var link in links.out) {
          ...
          if (linkdata['target_hw'] != '') {
            var linkhtml = '<ul>'+preview+' → <a target="_top" href="#/'+linkdata['target_dict']+'/edit/entry/'+linkdata['target_entry']+'/view">'+linkdata['target_dict']+' : '+linkdata['target_el']+' : '+linkdata['target_id']+'</a>';
      ...
      if (links.in.length > 0) {
        ...
        for (var link in links.in) {
          ...
          if (linkdata['source_hw'] != '') {
            var linkhtml = '<ul>'+linkdata["target_id"]+' ← <a target="_top" href="#/'+linkdata['source_dict']+'/edit/entry/'+linkdata['source_entry']+'/view">'+linkdata['source_dict']+' : '+linkdata['source_hw']+' : '+linkdata['source_el']+' : '+linkdata['source_id']+'</a>';
          } else if (linkdata['source_entry'] != '') {
            var linkhtml = '<ul>'+linkdata["target_id"]+' ← <a target="_top" href="#/'+linkdata['source_dict']+'/edit/entry/'+linkdata['source_entry']+'/view">'+linkdata['source_dict']+' : '+linkdata['source_el']+' : '+linkdata['source_id']+'</a>';
          } else {
