...
Editing.render=function(div, json){
  ...
  $div.append("<label><input type='radio' name='editing_xonomyMode' id='editing_xonomyMode_laic' value='laic' "+(json.xonomyMode=="laic"?"checked='checked'":"")+"/> Friendly mode<label>");
  ...
  else if(json.xonomyMode=="laic") $div.append("<div class='instro'>When editing an entry in <b>Friendly mode</b> the XML source code is hidden and the entry looks more like a bulleted list.</div><div class='instro'><img src='../../../docs/mode-laic.png' alt='Illustration'/>");
